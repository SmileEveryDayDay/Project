...
- 签名秘钥文件
- 图片素材
  + PNG 或 JPEG 格式的文件，大小不得超过 1 MB，尺寸为 512 x 512 像素的图标
  + PNG 或 JPEG 格式的文件，大小不得超过 1 MB，尺寸为 1024 x 500 像素的置顶大图
  + 2 到 8 张PNG 或 JPEG 格式的手机屏幕截图。每张的大小不得超过 8 MB，宽高比为 16:9 或 9:16，各条边的尺寸介于 320 像素和 3840 像素之间
  * 7 英寸、10 英寸平板电脑屏幕截图
